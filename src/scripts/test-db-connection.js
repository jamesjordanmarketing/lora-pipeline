...
async function main() {
  ...
  if (!databaseUrl) {
    ...
    console.error('  C:\\Users\\james\\Master\\BrightHub\\BRun\\lora-pipeline\\.env.local');
    process.exit(1);
  }
  ...
  console.log('  pmc/context-ai/pmct/mock-data-execution-prompt-connection-issues_v1.md');
  console.log('═'.repeat(60) + '\n');
