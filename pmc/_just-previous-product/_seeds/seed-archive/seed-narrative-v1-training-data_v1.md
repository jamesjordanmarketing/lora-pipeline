...
`C:\Users\james\Master\BrightHub\brun\lora-pipeline\pmc\context-ai\pmct\c-alpha-build_v3.4-LoRA-FP-generation_v3.md`
`C:\Users\james\Master\BrightHub\brun\lora-pipeline\pmc\context-ai\pmct\GENERATION-COMPLETE-STATUS.md`
...
`C:\Users\james\Master\BrightHub\brun\lora-pipeline\pmc\context-ai\pmct\c-alpha-build_v3.4-LoRA-FP-convo-10-complete.json` (most recent seed file of first "10")
...
`C:\Users\james\Master\BrightHub\brun\lora-pipeline\pmc\context-ai\pmct\c-alpha-build_v3.4_emotional-dataset-emotional-taxonomy.md`
...
The process will be called the lora-pipeline process and we need to design a way to build these 90 data sets through this UI.
...
Remember to write the results and output to: `C:\Users\james\Master\BrightHub\brun\lora-pipeline\pmc\product\03-bmo-functional-requirements-lora-pipeline-module.md`