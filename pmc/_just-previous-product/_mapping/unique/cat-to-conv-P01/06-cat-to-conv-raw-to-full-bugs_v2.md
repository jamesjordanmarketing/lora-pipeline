...
**Production URL:** https://lora-pipeline-three.vercel.app/conversations  
...
```bash
curl https://lora-pipeline-three.vercel.app/api/conversations | jq '.conversations[0] | {conversation_id, conversation_name}'
```
...
2. Select project: lora-pipeline
3. Go to "Logs" tab
...
**Test:**
```bash
curl -X POST https://lora-pipeline-three.vercel.app/api/conversations/1fa10a33-1817-4969-bf4c-06650e54690c/enrich \
