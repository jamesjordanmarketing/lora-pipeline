...
3. **User Journey Integration**
   - **User Journey Document:** `C:/Users/james/Master/BrightHub/BRun/lora-pipeline/pmc/product/03.5-pipeline-user-journey.md`
...
1. Each atomic change MUST be logged individually in `pmc/product/_tools/cache/pipeline-fr-changes.log`:
