...
- `C:\Users\james\Master\BrightHub\brun\lora-pipeline\pmc\context-ai\pmct\run-gap-check.js`
- `C:\Users\james\Master\BrightHub\brun\lora-pipeline\pmc\context-ai\pmct\generate-fr-checks.js`
- `C:\Users\james\Master\BrightHub\brun\lora-pipeline\pmc\context-ai\pmct\debug-glob.js`
- `C:\Users\james\Master\BrightHub\brun\lora-pipeline\pmc\context-ai\pmct\fr-checks.json`
- `C:\Users\james\Master\BrightHub\brun\lora-pipeline\pmc\context-ai\pmct\fr-checks.generated.json`
- Report output: `C:\Users\james\Master\BrightHub\brun\lora-pipeline\pmc\context-ai\pmct\gap-report_v2-train.md`
...
```
node pmc\context-ai\pmct\generate-fr-checks.js
```
- Produces: `C:\Users\james\Master\BrightHub\brun\lora-pipeline\pmc\context-ai\pmct\fr-checks.generated.json`.

2) Run the gap check:
```
node pmc\context-ai\pmct\run-gap-check.js
```
- Produces: `C:\Users\james\Master\BrightHub\brun\lora-pipeline\pmc\context-ai\pmct\gap-report_v2-train.md`.

3) Review the report:
- Open `C:\Users\james\Master\BrightHub\brun\lora-pipeline\pmc\context-ai\pmct\gap-report_v2-train.md`.
...
### Common Operations
- Update base checks: edit `C:\Users\james\Master\BrightHub\brun\lora-pipeline\pmc\context-ai\pmct\fr-checks.json`.
...
- Debug glob patterns: use `C:\Users\james\Master\BrightHub\brun\lora-pipeline\pmc\context-ai\pmct\debug-glob.js` (see Troubleshooting).
...
- Generator reads code references from the spec and emits FR checks:
  - `C:\Users\james\Master\BrightHub\brun\lora-pipeline\pmc\context-ai\pmct\generate-fr-checks.js` parses `03-bmo-functional-requirements.md`.
...
- Debug and local verification:
  - Use `C:\Users\james\Master\BrightHub\brun\lora-pipeline\pmc\context-ai\pmct\debug-glob.js` to print the regex and test a specific path.
...
- Output file:
  - `C:\Users\james\Master\BrightHub\brun\lora-pipeline\pmc\context-ai\pmct\gap-report_v2-train.md`
- Appendix includes an index snapshot with the directories scanned.

### Generator (Doc → Checks)
- Script: `C:\Users\james\Master\BrightHub\brun\lora-pipeline\pmc\context-ai\pmct\generate-fr-checks.js`
  ...
  "artifacts": [
    {
      "type": "component",
      "path_patterns": [
        "C:/Users/james/Master/BrightHub/brun/lora-pipeline/src/components/example/**/*.tsx"
      ],
    ...
    },
    {
      "type": "route",
      "path_patterns": [
        "C:/Users/james/Master/BrightHub/brun/lora-pipeline/src/app/api/example/route.ts"
      ],
      "required": true
    }
  ],
...
```
2) Run `node pmc\context-ai\pmct\run-gap-check.js` and review the report output.
...
```
node pmc\context-ai\pmct\debug-glob.js
```
...
- Update product doc with new references:
  - `C:\Users\james\Master\BrightHub\brun\lora-pipeline\pmc\product\03-bmo-functional-requirements.md`
- Regenerate checks: `node pmc\context-ai\pmct\generate-fr-checks.js`
- Run matcher: `node pmc\context-ai\pmct\run-gap-check.js`
- Review report: `C:\Users\james\Master\BrightHub\brun\lora-pipeline\pmc\context-ai\pmct\gap-report_v2-train.md`
...
- Matcher: `C:\Users\james\Master\BrightHub\brun\lora-pipeline\pmc\context-ai\pmct\run-gap-check.js`
- Generator: `C:\Users\james\Master\BrightHub\brun\lora-pipeline\pmc\context-ai\pmct\generate-fr-checks.js`
- Glob Debugger: `C:\Users\james\Master\BrightHub\brun\lora-pipeline\pmc\context-ai\pmct\debug-glob.js`
- Base FR Checks: `C:\Users\james\Master\BrightHub\brun\lora-pipeline\pmc\context-ai\pmct\fr-checks.json`
- Generated FR Checks: `C:\Users\james\Master\BrightHub\brun\lora-pipeline\pmc\context-ai\pmct\fr-checks.generated.json`
- Report Output: `C:\Users\james\Master\BrightHub\brun\lora-pipeline\pmc\context-ai\pmct\gap-report_v2-train.md`
