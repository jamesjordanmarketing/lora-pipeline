...
2. Codebase Artifact Indexing
   - Build a searchable index of `C:\Users\james\Master\BrightHub\brun\lora-pipeline\src\` artifacts:
     ...
     - Data: `C:\Users\james\Master\BrightHub\brun\lora-pipeline\src\supabase\functions\**`, `C:\Users\james\Master\BrightHub\brun\lora-pipeline\src\supabase\migrations\**`, `C:\Users\james\Master\BrightHub\brun\lora-pipeline\src\lib\database\**`, `C:\Users\james\Master\BrightHub\brun\lora-pipeline\src\lib\supabase*.ts`.
...
4. Reporting
   - Generate `C:\Users\james\Master\BrightHub\brun\lora-pipeline\pmc\context-ai\pmct\gap-report_v2-train.md`:
...
```json
{
  ...
  "artifacts": [
    { "type": "component", "path_patterns": ["C\\\\Users\\\\james\\\\Master\\\\BrightHub\\\\brun\\\\lora-pipeline\\\\src\\\\components\\\\auth\\\\**\\\\*.tsx", "C\\\\Users\\\\james\\\\Master\\\\BrightHub\\\\brun\\\\lora-pipeline\\\\src\\\\app\\\\(auth)\\\\**\\\\page.tsx"], "symbol_patterns": ["Login", "SignIn"], "required": true },
    { "type": "service", "path_patterns": ["C\\\\Users\\\\james\\\\Master\\\\BrightHub\\\\brun\\\\lora-pipeline\\\\src\\\\lib\\\\auth-service.ts"], "symbol_patterns": ["export function signIn", "export async function getSession"], "required": true },
    { "type": "route", "path_patterns": ["C\\\\Users\\\\james\\\\Master\\\\BrightHub\\\\brun\\\\lora-pipeline\\\\src\\\\app\\\\api\\\\auth\\\\route.ts"], "symbol_patterns": [], "required": false }
  ],
  "threshold": 2,
...
```json
{
  ...
  "artifacts": [
    ...
    { "type": "migration", "path_patterns": ["C\\\\Users\\\\james\\\\Master\\\\BrightHub\\\\brun\\\\lora-pipeline\\\\src\\\\supabase\\\\migrations\\\\**\\\\*.sql"], "symbol_patterns": ["CREATE TABLE chunks"], "required": false }
  ],
  "threshold": 2,
...
- Requirements Extractor
  ...
  - Normalize into `C:\Users\james\Master\BrightHub\brun\lora-pipeline\pmc\context-ai\pmct\fr-catalog.json` with tags inferred from content and known domains.

- Artifact Indexer
  - Walk `C:\Users\james\Master\BrightHub\brun\lora-pipeline\src\` and `C:\Users\james\Master\BrightHub\brun\lora-pipeline\src\supabase\` to collect files by type.
...
- Configuration
  - `C:\Users\james\Master\BrightHub\brun\lora-pipeline\pmc\context-ai\pmct\fr-checks.json`: holds FRChecks with path/symbol patterns.
...
- Domain-to-Directory Defaults
  - `auth` → `C:\Users\james\Master\BrightHub\brun\lora-pipeline\src\lib\auth-service.ts`, `C:\Users\james\Master\BrightHub\brun\lora-pipeline\src\components\auth\`, `C:\Users\james\Master\BrightHub\brun\lora-pipeline\src\app\(auth)\`.
  ...
  - `data/supabase` → `C:\Users\james\Master\BrightHub\brun\lora-pipeline\src\supabase\migrations\`, `C:\Users\james\Master\BrightHub\brun\lora-pipeline\src\lib\supabase*.ts`, `C:\Users\james\Master\BrightHub\brun\lora-pipeline\src\supabase\functions\`.
...
- FR AUTH LOGIN 001
  ...
  - Confidence: 0.86
  - Expected Artifacts:
    - Component: `C:\Users\james\Master\BrightHub\brun\lora-pipeline\src\components\auth\Login.tsx` or `C:\Users\james\Master\BrightHub\brun\lora-pipeline\src\app\(auth)\page.tsx`
    - Service: `C:\Users\james\Master\BrightHub\brun\lora-pipeline\src\lib\auth-service.ts` (`signIn`, `getSession`)
  - Found Evidence:
    - `C:\Users\james\Master\BrightHub\brun\lora-pipeline\src\lib\auth-service.ts` (exported `signIn`)
    - `C:\Users\james\Master\BrightHub\brun\lora-pipeline\src\app\(auth)\page.tsx` (Login UI)
  - Missing:
    - API `C:\Users\james\Master\BrightHub\brun\lora-pipeline\src\app\api\auth\route.ts` (optional)
  - Manual Review:
...
## Appendix: Observed Codebase Landmarks (from `C:\Users\james\Master\BrightHub\brun\lora-pipeline\src\`)
