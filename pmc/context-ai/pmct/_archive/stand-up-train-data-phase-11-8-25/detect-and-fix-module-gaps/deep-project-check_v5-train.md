...
4. Reporting
   - Generate `C:\Users\james\Master\BrightHub\brun\lora-pipeline\pmc\context-ai\pmct\gap-report_v2-train.md` with summary, per-FR details, evidence, and manual review prompts.
...
- Requirements Extractor
  ...
  - Normalize into `C:\Users\james\Master\BrightHub\brun\lora-pipeline\pmc\context-ai\pmct\fr-catalog.json` with tags inferred from content and domains.
