 ...
 *  - Default input: pmc/product/_mapping/[abbrev]/iteration-8-LoRA-pipeline-figma-conversion.md
 */
...
async function main() {
  try {
    ...
    const defaultUnstructuredPath = path.resolve(__dirname, '..', '_mapping', projectAbbreviation, 'iteration-8-LoRA-pipeline-figma-conversion.md');
