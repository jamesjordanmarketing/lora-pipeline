...
```
Default: ../mapping/pipeline/iteration-8-LoRA-pipeline-figma-conversion.md
...
Default: pmc/product/_mapping/pipeline/iteration-8-LoRA-pipeline-figma-conversion.md
Exists: TRUE
Path (press Enter for default): 
✓ Using unstructured spec: pmc/product/_mapping/pipeline/iteration-8-LoRA-pipeline-figma-conversion.md
...
📋 Summary:
─────────
Unstructured Input: pmc/product/_mapping/pipeline/iteration-8-LoRA-pipeline-figma-conversion.md
