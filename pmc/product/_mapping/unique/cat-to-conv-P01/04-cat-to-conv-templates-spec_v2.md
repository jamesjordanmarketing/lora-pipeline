# Regarding: The Templates Implementation Spec here: `C:\Users\james\Master\BrightHub\brun\lora-pipeline\pmc\product\04-categories-to-conversation-templates_spec_v1.md`

Read the current overview for a full context:
C:\Users\james\Master\BrightHub\brun\lora-pipeline\pmc\product\04-categories-to-conversation-strategic-overview_v1.md
Then read the connections and changes we made here: `C:\Users\james\Master\BrightHub\brun\lora-pipeline\pmc\product\04-categories-to-conversation-pipeline_spec_v1.md`. This is complete and coded.

Fully understand the codebase of this application located here:

* `C:\Users\james\Master\BrightHub\brun\lora-pipeline\src\`

So we need to update: `C:\Users\james\Master\BrightHub\brun\lora-pipeline\pmc\product\04-categories-to-conversation-templates_spec_v1.md` to map to the current code implementation and include some important additional requirements.
...
They are to be derived and extrapolated from: `C:\Users\james\Master\BrightHub\brun\lora-pipeline\pmc\context-ai\pmct\c-alpha-build_v3.4-LoRA-FP-100-spec.md`
...
Reading the current prompts in: `C:\Users\james\Master\BrightHub\brun\lora-pipeline\pmc\context-ai\pmct\c-alpha-build_v3.4-LoRA-FP-100-spec.md`
Reviewing the current data set schema: `C:\Users\james\Master\BrightHub\brun\lora-pipeline\pmc\context-ai\pmct\training-data-seeds\c-alpha-build_v3.4_emotional-dataset-JSON-format_v3.json`
Reviewing the current data set data: `C:\Users\james\Master\BrightHub\brun\lora-pipeline\pmc\context-ai\pmct\training-data-seeds\c-alpha-build_v3.4-LoRA-FP-convo-10-complete.json`
...
These will be collected on the [https://lora-pipeline-three.vercel.app/conversations/generate](https://lora-pipeline-three.vercel.app/conversations/generate) page (stubs exist already)
...
Output a new specification here: `C:\Users\james\Master\BrightHub\brun\lora-pipeline\pmc\product\_mapping\unique\cat-to-conv-P01\04-cat-to-conv-templates-execution-E01.md'`
...
So we need to develop this into the current app with a persistent table that shows all conversations, with filtering, processing status view, an export functionality. The UI for this is already built and is here: [https://lora-pipeline-three.vercel.app/conversations](https://lora-pipeline-three.vercel.app/conversations). We will need to hook up all of these functions with the actual Conversations.
...
`C:\Users\james\Master\BrightHub\brun\lora-pipeline\pmc\product\_mapping\unique\cat-to-conv-P01\01-cat-to-conv-conversation-storage-spec_v1.md'`
...
8. For all Supabase operations use the Supabase Agent Ops Library (SAOL):
   ...
   **Quick Start Guide:** `C:\Users\james\Master\BrightHub\brun\lora-pipeline\supa-agent-ops\saol-agent-quick-start-guide_v1.md`

9. Use this file: `C:\Users\james\Master\BrightHub\brun\lora-pipeline\pmc\product\_mapping\fr-maps\04-FR-wireframes-execution-E05.md` as an example and a template of a good execution file.
