...
**Primary Seed Data Source**: `C:\Users\james\Master\BrightHub\brun\lora-pipeline\pmc\context-ai\pmct\c-alpha-build_v3.4-LoRA-FP-100-spec.md`
...
**Validation Source**: 10 seed conversations in `C:\Users\james\Master\BrightHub\brun\lora-pipeline\pmc\context-ai\pmct\training-data-seeds/`
...
- **Full Manual**: `C:\Users\james\Master\BrightHub\brun\lora-pipeline\supa-agent-ops\saol-agent-manual_v2.md`
...
- Access to `C:\Users\james\Master\BrightHub\brun\lora-pipeline\pmc\context-ai\pmct\c-alpha-build_v3.4-LoRA-FP-100-spec.md`
- SAOL library available
- Supabase service role key configured

### Context

The lora-pipeline application currently uses free-text fields (persona, emotion, topic) in the conversations table. This prompt creates structured scaffolding data tables to replace free-text with dropdown selections, ensuring consistency and enabling methodology-driven conversation generation.
...
You are implementing the database foundation for the conversation scaffolding system in the lora-pipeline application. This involves creating three new tables (personas, emotional_arcs, training_topics), adding foreign key columns to existing tables, extracting seed data from specifications, and populating the database.

## Critical Instructions

1. **Use SAOL for all database operations**:
   - Library location: `C:\Users\james\Master\BrightHub\brun\lora-pipeline\supa-agent-ops\`
   - Quick Start: `C:\Users\james\Master\BrightHub\brun\lora-pipeline\supa-agent-ops\saol-agent-quick-start-guide_v1.md`

2. **Read specifications carefully**:
   - `C:\Users\james\Master\BrightHub\brun\lora-pipeline\pmc\product\04-categories-to-conversation-pipeline-spec_v1.md` (lines 84-510)
...
3. **Extract seed data from**:
   ...
   - Cross-reference with seed conversations in `C:\Users\james\Master\BrightHub\brun\lora-pipeline\pmc\context-ai\pmct\training-data-seeds/`
...
```bash
cat "C:\Users\james\Master\BrightHub\brun\lora-pipeline\pmc\context-ai\pmct\c-alpha-build_v3.4-LoRA-FP-100-spec.md"
```
...
```bash
ls "C:\Users\james\Master\BrightHub\brun\lora-pipeline\pmc\context-ai\pmct\training-data-seeds/"
```
...
3. **Refer to specification for complete interfaces**:
   - `C:\Users\james\Master\BrightHub\brun\lora-pipeline\pmc\product\04-categories-to-conversation-pipeline-spec_v1.md`
