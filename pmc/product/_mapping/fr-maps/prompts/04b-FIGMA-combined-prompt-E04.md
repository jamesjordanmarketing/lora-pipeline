# E04 — Combined Wireframe Generator Prompt (v1)
...
1. Read and analyze all individual FR prompts from: 04-pipeline-FIGMA-wireframes-output-E04.md
...
5. Write the final combined FIGMA prompt to: pipeline-04-pipeline-FIGMA-wireframes-combined-output-E04.md

**CRITICAL OUTPUT FILE:** The final combined Figma prompt MUST be written to:
`C:\Users\james\Master\BrightHub\BRun\lora-pipeline\pmc\product\_mapping\fr-maps\pipeline-04-pipeline-FIGMA-wireframes-combined-output-E04.md`
...
**Stage Information:**
- **Stage Number:** 4 (e.g., 01, 02, 03, etc.)
- **Stage Name:** Stage 4 — Model Artifacts & Downloads (e.g., "Training Job Configuration & Setup")
- **Section ID:** E04 (e.g., E01)
- **Product Abbreviation:** pipeline
- **Project Name:** LoRA Pipeline

**File Paths (FULL ABSOLUTE PATHS):**
- **Input Wireframe Output File:** C:\Users\james\Master\BrightHub\BRun\lora-pipeline\pmc\product\_mapping\fr-maps\04-pipeline-FIGMA-wireframes-output-E04.md
...
- **Source FR Specification File:** C:\Users\james\Master\BrightHub\BRun\lora-pipeline\pmc\product\_mapping\fr-maps\04-pipeline-FR-wireframes-E04.md
  - Example: `C:\Users\james\Master\BrightHub\BRun\lora-pipeline\pmc\product\_mapping\fr-maps\04-pipeline-FR-wireframes-E01.md`
- **FINAL Combined FIGMA Output File (WHERE TO WRITE):** C:\Users\james\Master\BrightHub\BRun\lora-pipeline\pmc\product\_mapping\fr-maps\pipeline-04-pipeline-FIGMA-wireframes-combined-output-E04.md
...
- **Analysis Documentation File:** C:\Users\james\Master\BrightHub\BRun\lora-pipeline\pmc\context-ai\pmct\iteration-7-figma-combined-E04-analysis_v1.md
...
Read the input wireframe output file at: `C:\Users\james\Master\BrightHub\BRun\lora-pipeline\pmc\product\_mapping\fr-maps\04-pipeline-FIGMA-wireframes-output-E04.md`
...
**YOU MUST WRITE THE FINAL COMBINED FIGMA PROMPT TO:** `C:\Users\james\Master\BrightHub\BRun\lora-pipeline\pmc\product\_mapping\fr-maps\pipeline-04-pipeline-FIGMA-wireframes-combined-output-E04.md`
...
Write the following content to: `C:\Users\james\Master\BrightHub\BRun\lora-pipeline\pmc\product\_mapping\fr-maps\pipeline-04-pipeline-FIGMA-wireframes-combined-output-E04.md`
...
**Generated From:**
- Input File: C:\Users\james\Master\BrightHub\BRun\lora-pipeline\pmc\product\_mapping\fr-maps\04-pipeline-FIGMA-wireframes-output-E04.md
- FR Specifications: C:\Users\james\Master\BrightHub\BRun\lora-pipeline\pmc\product\_mapping\fr-maps\04-pipeline-FR-wireframes-E04.md
- Analysis: C:\Users\james\Master\BrightHub\BRun\lora-pipeline\pmc\context-ai\pmct\iteration-7-figma-combined-E04-analysis_v1.md
...
- **Stage 4 User Goals:** [Combined goals from all FRs]
...
1. **Read the input wireframe output file** at `C:\Users\james\Master\BrightHub\BRun\lora-pipeline\pmc\product\_mapping\fr-maps\04-pipeline-FIGMA-wireframes-output-E04.md`
...
4. **Process through 4 phases:**
   - Phase 1: Write analysis to `C:\Users\james\Master\BrightHub\BRun\lora-pipeline\pmc\context-ai\pmct\iteration-7-figma-combined-E04-analysis_v1.md`
...
5. **Replace all placeholders** with actual values:
   - `4` → e.g., "01"
   - `Stage 4 — Model Artifacts & Downloads` → e.g., "Training Job Configuration & Setup"
   - `E04` → e.g., "E01"
...
const placeholders = {
  '4': '01',
  'Stage 4 — Model Artifacts & Downloads': 'Training Job Configuration & Setup',
  'E04': 'E01',
  'pipeline': 'pipeline',
  'LoRA Pipeline': 'LoRA Training Pipeline',
  '2025-12-19': new Date().toISOString().split('T')[0],
  'C:\Users\james\Master\BrightHub\BRun\lora-pipeline\pmc\product\_mapping\fr-maps\04-pipeline-FIGMA-wireframes-output-E04.md': absolutePath('...04-pipeline-FIGMA-wireframes-output-E01.md'),
  'C:\Users\james\Master\BrightHub\BRun\lora-pipeline\pmc\product\_mapping\fr-maps\04-pipeline-FR-wireframes-E04.md': absolutePath('...04-pipeline-FR-wireframes-E01.md'),
  'C:\Users\james\Master\BrightHub\BRun\lora-pipeline\pmc\product\_mapping\fr-maps\pipeline-04-pipeline-FIGMA-wireframes-combined-output-E04.md': absolutePath('...pipeline-04-pipeline-FIGMA-wireframes-combined-output-E01.md'),
  ...
  'C:\Users\james\Master\BrightHub\BRun\lora-pipeline\pmc\context-ai\pmct\iteration-7-figma-combined-E04-analysis_v1.md': absolutePath('...iteration-7-figma-combined-E01-analysis_v1.md'),
};
```

**Expected Outputs:**
1. **Analysis File:** Detailed breakdown of FRs, relationships, overlaps, simplifications (written to `C:\Users\james\Master\BrightHub\BRun\lora-pipeline\pmc\context-ai\pmct\iteration-7-figma-combined-E04-analysis_v1.md`)
2. **Final Combined FIGMA Prompt File:** Single Figma-ready prompt for the entire stage (written to `C:\Users\james\Master\BrightHub\BRun\lora-pipeline\pmc\product\_mapping\fr-maps\pipeline-04-pipeline-FIGMA-wireframes-combined-output-E04.md`)
