...
## Context and Purpose
You are tasked with transforming unstructured project data into a comprehensive seed narrative for LoRA Pipeline. 
...
- **Raw Data:** ``pmc/product/_tools/consolidate-persona-criteria.js``
...
```
`pmc/_mapping/pipeline/00-pipeline-seed-narrative.md`
```
