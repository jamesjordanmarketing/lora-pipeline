# LoRA Pipeline - Integrated Extension Specification
...
This specification describes how to implement the LoRA Pipeline as an EXTENSION to the existing BrightHub application.
...
**What We're Adding**:
- New database tables for LoRA Pipeline
...
**What We're Adding** (LoRA Pipeline specific):
...
**Original Infrastructure**: Prisma, NextAuth.js, NextAuth, S3, BullMQ, Redis, SWR  
**Actual Infrastructure**: Supabase Client (direct queries), Supabase Auth, Supabase Auth, Supabase Storage, Supabase Edge Functions + Cron, Supabase Edge Functions + Cron, React Query
...
**Project**: LoRA Pipeline
**Extension Status**: ✅ Transformed to use existing infrastructure  
**Original Infrastructure**: None specified  
**Actual Infrastructure**: Using existing patterns
...
**Project**: LoRA Pipeline
**Extension Status**: ✅ Transformed to use existing infrastructure  
**Original Infrastructure**: S3, BullMQ, Server-Sent Events, SSE  
**Actual Infrastructure**: Supabase Storage, Supabase Edge Functions + Cron, React Query polling, React Query polling
...
**Project**: LoRA Pipeline
**Extension Status**: ✅ Transformed to use existing infrastructure  
**Original Infrastructure**: S3  
**Actual Infrastructure**: Supabase Storage
...
**Project**: LoRA Pipeline
**Extension Status**: ✅ Transformed to use existing infrastructure  
**Original Infrastructure**: Prisma  
**Actual Infrastructure**: Supabase Client (direct queries)
...
**Project**: LoRA Pipeline
**Extension Status**: ✅ Transformed to use existing infrastructure  
**Original Infrastructure**: Prisma, S3, Redis, SSE  
**Actual Infrastructure**: Supabase Client (direct queries), Supabase Storage, Supabase Edge Functions + Cron, React Query polling
