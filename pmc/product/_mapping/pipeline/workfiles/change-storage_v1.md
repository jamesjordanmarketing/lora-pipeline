...
**File**: `C:\Users\james\Master\BrightHub\BRun\lora-pipeline\.secrets\deployment-secrets.md`
...
**File**: `C:\Users\james\Master\BrightHub\BRun\lora-pipeline\pmc\product\_mapping\pipeline\workfiles\docker-urls-and-edge-changes_v1.md`
...
```bash
# Open in editor
code C:\Users\james\Master\BrightHub\BRun\lora-pipeline\.secrets\deployment-secrets.md
```

### Update Context Document
```bash
# Open in editor
code C:\Users\james\Master\BrightHub\BRun\lora-pipeline\pmc\system\plans\context-carries\context-carry-info-11-15-25-1114pm.md
```

### Update Instructions
```bash
# Open in editor
code C:\Users\james\Master\BrightHub\BRun\lora-pipeline\pmc\product\_mapping\pipeline\workfiles\docker-urls-and-edge-changes_v1.md
```
