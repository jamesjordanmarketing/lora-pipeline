...
**Stage Information:**
- **Stage Number:** [STAGE_NUMBER] (e.g., 01, 02, 03, etc.)
- **Stage Name:** [STAGE_NAME] (e.g., "Training Job Configuration & Setup")
- **Section ID:** [SECTION_ID] (e.g., E01)
- **Product Abbreviation:** [PRODUCT_ABBR]
- **Project Name:** [PROJECT_NAME]

**File Paths:**
- **Input Wireframe Output File:** [INPUT_WIREFRAMES_FILE_PATH]
- **Source FR Specification File:** [FR_SPEC_FILE_PATH]
- **FINAL Combined FIGMA Output File (WHERE TO WRITE):** [FINAL_FIGMA_OUTPUT_FILE_PATH]
  - **CRITICAL:** Write the final combined Figma prompt to this file

**Reference Documents:**
- **Product Overview:** [OVERVIEW_FILE_PATH]
- **User Stories:** [USER_STORIES_FILE_PATH]
- **User Journey:** [USER_JOURNEY_FILE_PATH]
- **Functional Requirements:** [FUNCTIONAL_REQUIREMENTS_FILE_PATH]

**Analysis Worksheet:**
- **Analysis Documentation File:** [ANALYSIS_FILE_PATH]
...
Read the input wireframe output file at: `[INPUT_WIREFRAMES_FILE_PATH]`
...
**YOU MUST WRITE THE FINAL COMBINED FIGMA PROMPT TO:** `[FINAL_FIGMA_OUTPUT_FILE_PATH]`
...
Write the following content to: `[FINAL_FIGMA_OUTPUT_FILE_PATH]`

```markdown
# [PROJECT_NAME] - Stage [STAGE_NUMBER] Combined Figma Wireframe Prompt
**Version:** 1.0  
**Date:** [CURRENT_DATE]  
**Stage:** [STAGE_NAME]  
...
**Generated From:**
- Input File: [INPUT_WIREFRAMES_FILE_PATH]
- FR Specifications: [FR_SPEC_FILE_PATH]
...
**Title:** [STAGE_NAME] - Complete Integrated Wireframe System
...
- **Stage [STAGE_NUMBER] User Goals:** [Combined goals from all FRs]
...
## Template Usage Instructions for Script. Not to be included to execute the above prompt

This template expects the script to:

1. **Read the input wireframe output file** at `[INPUT_WIREFRAMES_FILE_PATH]`
...
4. **Process through 4 phases:**
   - Phase 1: Write analysis to `[ANALYSIS_FILE_PATH]`
...
5. **Replace all placeholders** with actual values:
   - `[STAGE_NUMBER]` → e.g., "01"
   - `[STAGE_NAME]` → e.g., "Training Job Configuration & Setup"
   - `[SECTION_ID]` → e.g., "E01"
   - `[PRODUCT_ABBR]` → e.g., "pipeline"
   - `[PROJECT_NAME]` → e.g., "LoRA Training Pipeline"
...
const placeholders = {
  '[STAGE_NUMBER]': '01',
  '[STAGE_NAME]': 'Training Job Configuration & Setup',
  '[SECTION_ID]': 'E01',
  '[PRODUCT_ABBR]': 'pipeline',
  '[PROJECT_NAME]': 'LoRA Training Pipeline',
  '[CURRENT_DATE]': new Date().toISOString().split('T')[0],
  '[INPUT_WIREFRAMES_FILE_PATH]': absolutePath('...product/_mapping/fr-maps/04-pipeline-FIGMA-wireframes-output-E01.md'),
  '[FR_SPEC_FILE_PATH]': absolutePath('...product/_mapping/fr-maps/04-pipeline-FR-wireframes-E01.md'),
  '[FINAL_FIGMA_OUTPUT_FILE_PATH]': absolutePath('...product/_mapping/pipeline/figma-combined/04b-FIGMA-combined-prompt-E01-output.md'),
  '[OVERVIEW_FILE_PATH]': absolutePath('...product/01-pipeline-overview.md'),
  '[USER_STORIES_FILE_PATH]': absolutePath('...product/02-pipeline-user-stories.md'),
  '[USER_JOURNEY_FILE_PATH]': absolutePath('...product/02b-pipeline-user-journey.md'),
  '[FUNCTIONAL_REQUIREMENTS_FILE_PATH]': absolutePath('...product/03-pipeline-functional-requirements.md'),
  '[ANALYSIS_FILE_PATH]': absolutePath('...product/_mapping/pipeline/figma-combined/04b-FIGMA-combined-E01-WORKSHEET.md'),
};
```

**Expected Outputs:**
1. **Analysis Worksheet:** Detailed breakdown of FRs, relationships, overlaps, simplifications (written to `[ANALYSIS_FILE_PATH]`)
2. **Final Combined FIGMA Prompt File:** Single Figma-ready prompt for the entire stage (written to `[FINAL_FIGMA_OUTPUT_FILE_PATH]`)
