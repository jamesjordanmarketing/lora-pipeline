...
| Column | Type | Purpose |
|--------|------|---------|
| `id` | UUID | **PostgreSQL auto-generated PK** ← FK TARGET |
...
| `conversation_id` | UUID | **FK → conversations.id** (NOT conversation_id!) |
| `status` | TEXT | pending/completed/failed |

---

## 🔄 Issue History (This Sprint)

| Issue | Status | Session |
|-------|--------|---------|
| CHECK constraint on batch_jobs.status | ✅ Fixed | Earlier |
| Template NIL_UUID not found | ✅ Fixed | Earlier |
| Enrichment "Conversation not found" | ✅ Fixed | Previous (11/26) |
| **FK Constraint Violation** | 📋 Investigated | **Current (11/27)** |
| **UI Log Rendering Issue** | 📋 Investigated | **Current (11/27)** |
...
4. **Test URL:** https://lora-pipeline-three.vercel.app/bulk-generator
