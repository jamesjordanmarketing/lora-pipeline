...
- [ ] **Upload Test**:
  - [ ] Navigate to https://lora-pipeline-three.vercel.app/upload
  - [ ] Select a PDF file
  - [ ] Click upload
...
- [ ] **View Chunks Test**:
  - [ ] Navigate to https://lora-pipeline-three.vercel.app/dashboard
...
2. **Use Production URLs**: Test in actual environment
   - `https://lora-pipeline-three.vercel.app/upload`
   - `https://lora-pipeline-three.vercel.app/dashboard`
