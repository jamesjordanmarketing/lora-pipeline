...
**Or via API endpoint**:
```bash
curl https://lora-pipeline-three.vercel.app/api/conversations/22c81ac0-781f-4dcf-ad01-b69a95a24d60/validation-report
```
...
```bash
curl "https://lora-pipeline-three.vercel.app/api/conversations/22c81ac0-781f-4dcf-ad01-b69a95a24d60/download/raw"
```
...
require('dotenv').config({ path: path.resolve(__dirname, 'lora-pipeline/.env.local') });
const saol = require('./lora-pipeline/supa-agent-ops/dist/index.js');
...
- **Generate**: https://lora-pipeline-three.vercel.app/conversations/generate
- **Conversations**: https://lora-pipeline-three.vercel.app/conversations
- **Validation API**: https://lora-pipeline-three.vercel.app/api/conversations/[id]/validation-report
- **Download Raw**: https://lora-pipeline-three.vercel.app/api/conversations/[id]/download/raw
