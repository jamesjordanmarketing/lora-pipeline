...
Examples:
The prompts:
`C:\Users\james\Master\BrightHub\brun\lora-pipeline\pmc\product\_mapping\fr-maps\prompts\04-FR-wireframes-prompt-E[XX].md`
`C:\Users\james\Master\BrightHub\brun\lora-pipeline\pmc\product\_mapping\fr-maps\prompts\04-FR-wireframes-execution-prompts-E[XX].md`
and the spec file:
`C:\Users\james\Master\BrightHub\brun\lora-pipeline\pmc\product\_mapping\fr-maps\04-train-FR-wireframes-E[XX].md`

run the main prompt file. That will create the detailed task list:
`C:\Users\james\Master\BrightHub\brun\lora-pipeline\pmc\product\_mapping\fr-maps\04-train-FR-wireframes-E[XX]-output.md`
